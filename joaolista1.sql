...
insert into Livros (titulo, autor, ano_publicacao, disponivel, categoria, isbn, editora, quantidade_paginas, idioma)
values ('Detetive Cou: O caso da UNASP', 'Albert Einstein', 2010, true, 'Romantismo', '123-0064471567', 'EDUTEC', 60, 'Hebraico');
...
select titulo from Livros order by id asc limit 5;

select sum(quantidade_paginas), avg(quantidade_paginas), categoria
from Livros
